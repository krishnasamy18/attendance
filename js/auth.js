...
window.Auth = (() => {
  ...
  const ROUTE_RULES = {
    ...
    'hod.live-monitoring': { 'HOD': true },
    'attendance.view': { 'Student': true, 'Staff': true, 'HOD': true },
    'attendance.mark': { 'Staff': true },
    'attendance.manual': { 'Staff': true },
    'attendance.monitor': { 'HOD': true },
    'daily.reports': { 'HOD': true },
    'staff.daily-reports': { 'Staff': true },
    'daily-report': { 'Student': true },
    'low-attendance': { 'Staff': true, 'HOD': true },
    'students': { 'Staff': true, 'HOD': true },
    'students.management': { 'HOD': true },
    'staff': { 'HOD': true },
    'staff.management': { 'HOD': true },
    'staff.attendance': { 'HOD': true },
    'classes': { 'HOD': true },
    'subjects': { 'HOD': true },
